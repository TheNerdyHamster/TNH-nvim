...
_M.on_attach = function(client, bufnr)
	...
	-- Disable due to conflict with tmux
...
_M.capabilities = require("cmp_nvim_lsp").default_capabilities(vim.lsp.protocol.make_client_capabilities())
-- require'snippets'.use_suggested_mappings(true) -- for snippets.vim

-- Code actions
_M.capabilities.textDocument.codeAction = {
